    ...
    <div class="panel-body">
        ...
        <table id="order_data_table" class="table table-striped table-hover dt-responsive" cellspacing="0" width="100%">
            ...
            <tr>
                ...
                <td><a href="<?php echo e(url('admin/restaurants/view/'.$order->restaurant_id)); ?>" class="text-regular"><?php echo e(\App\Restaurants::getRestaurantsInfo($order->restaurant_id)->restaurant_name); ?></a>
                </td>
                ...
                <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right" role="menu"> 
                                    <li><a href="<?php echo e(url('admin/restaurants/view/'.$order->restaurant_id.'/orderlist/'.$order->id.'/Pending')); ?>"><i class="md md-lock"></i> Pending</a></li>
                                    <li><a href="<?php echo e(url('admin/restaurants/view/'.$order->restaurant_id.'/orderlist/'.$order->id.'/Processing')); ?>"><i class="md md-loop"></i> Processing</a></li>
                                    <li><a href="<?php echo e(url('admin/restaurants/view/'.$order->restaurant_id.'/orderlist/'.$order->id.'/Completed')); ?>"><i class="md md-done"></i> Completed</a></li>
                                    <li><a href="<?php echo e(url('admin/restaurants/view/'.$order->restaurant_id.'/orderlist/'.$order->id.'/Cancel')); ?>"><i class="md md-cancel"></i> Cancel</a></li>
                                    <li><a href="<?php echo e(url('admin/restaurants/view/'.$order->restaurant_id.'/orderlist/'.$order->id)); ?>"><i class="md md-delete"></i> Delete</a></li>
                                </ul>
                            </div> 
