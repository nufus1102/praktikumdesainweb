        ...
        <table id="data-table" class="table table-striped table-hover dt-responsive" cellspacing="0" width="100%">
            ...
            <tr>
                ...
                <td>
                    ...
                    <img src="<?php echo e(URL::asset('upload/menu/'.$item->menu_image.'-s.jpg')); ?>" width="80" class="img-circle border-white" alt="menu">

                   <?php else: ?>
                    <img src="<?php echo e(URL::asset('upload/menu_img_s.png')); ?>" width="80" class="img-circle border-white"/>
                   <?php endif; ?>
                </td>                
